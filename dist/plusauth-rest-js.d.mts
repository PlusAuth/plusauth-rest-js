 ...
 * @public
 */
type BodyType = Record<string, any> | string;
/**
 * @public
 */
 ...
 * @public
 */
interface AccountBlockingPolicy {
  enabled: boolean;
  /**
 ...
 * @public
 */
interface CreateAuthPlusCategory {
  /**
   * Category name
   */
  name: string | null;
 ...
 * @public
 */
interface CreateAuthPlusDevice {
  name?: string | null;
  device_identifier: string;
  model: string;
  os: string;
 ...
 * @public
 */
type CreateTenantAdministrator = {
  email: string;
  user_id?: string;
  permissions?: string[];
  [k: string]: any;
 ...
 * @public
 */
interface CreateTenantCustomDomain {
  domain: string;
}
/**
 * @public
 ...
 * @public
 */
interface ExtendedPaginatedResult {
  [k: string]: any;
}
/**
 * @public
 */
interface FVCredential {
  /**
   * Authenticator id
   */
  id: string;
...
interface JobRun {
   ...
   */
  progress?: string | boolean | number | {
    [k: string]: any;
  };
  /**
   * Execution result
 ...
 * @public
 */
type MFAType = "sms" | "otp" | "push" | "webauthn" | "email" | "e-sign" | "fv";
/**
 * @public
 */
interface MessagebirdSmsProvider {
  type: "sms";
  /**
   * Is connection using custom scripts
   */
 ...
 * @public
 */
type PlanType = "free" | "basic" | "pro" | "enterprise" | "on-premise";
/**
 * @public
 */
type Provider = ({
 ...
 * @public
 */
interface ResourceAuthorizedClient {
  /**
   * Unique identifier of entity
   */
  id: string;
 ...
 * @public
 */
interface ThreeGBilisimSmsProvider {
  type: "sms";
  /**
   * Is connection using custom scripts
   */
 ...
 * @public
 */
interface UpdateAuthPlusAccount {
  name: string | null;
  icon: string | null;
  /**
   * Category order
 ...
 * @public
 */
interface UpdateAuthPlusCategory {
  /**
   * Category name
   */
  name: string | null;
 ...
 * @public
 */
interface UpdateAuthPlusDevice {
  name?: string | null;
  details: {
    [k: string]: any;
  };
 ...
 * @public
 */
interface UpdateEDevletConnection {
  enabled?: boolean;
  updated_at?: string | null;
  created_at?: string;
  is_default?: boolean;
 ...
 * @public
 */
interface UpdateESignConnection {
  type?: "e-sign";
  provider?: "plusauth";
  enabled?: boolean;
  /**
 ...
 * @public
 */
type UpdateEnterpriseConnection = {
  type?: "enterprise";
  [k: string]: any;
} & ({
  enabled?: boolean;
 ...
 * @public
 */
interface UpdateLDAPConnection {
  enabled?: boolean;
  updated_at?: string | null;
  created_at?: string;
  is_default?: boolean;
 ...
 * @public
 */
interface UpdateSAMLConnection {
  enabled?: boolean;
  updated_at?: string | null;
  created_at?: string;
  is_default?: boolean;
 ...
 * @public
 */
interface UpdateTenantSettings {
  branding?: {
    display_name?: string | null;
  };
  default_strategy?: string | null;
 ...
 * @public
 */
interface UpdateWebAuthNConnection {
  type?: "webauthn";
  provider?: "plusauth";
  enabled?: boolean;
  /**
...
//#endregion
//#region src/api/connections.d.ts
...
//#endregion
//#region src/api/customDomains.d.ts
...
declare class LogService extends HttpService {
  ...
  If you are familiar with Elasticsearch, Kibana, or Grafana date math queries, PlusAuth follows the same concepts.
  A date math expression starts with an anchor date, which can be either `now` or a date string ending with `||`.
  The anchor date can optionally be followed by one or more math expressions:
  - `+1h`: Add one hour
  - `-1d`: Subtract one day
...
//#endregion
//#region src/api/moduleSettings.d.ts
...
//#endregion
//#region src/api/roleGroups.d.ts
...
//#endregion
//#region src/api/tenantAdministrators.d.ts
 ...
 * @public
 */
declare class PlusAuthRestError extends Error {
  error?: string;
  error_description?: string;
  status?: number;
 ...
 * @public
 */
declare class PlusAuthRestClient {
